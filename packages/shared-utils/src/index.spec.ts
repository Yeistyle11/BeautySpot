...
describe('Shared Utils', () => {
  ...
  describe('formatDate', () => {
    ...
    it('debería manejar diferentes días de la semana', () => {
      expect(formatDate('2024-01-01')).toMatch(/domingo/); // Domingo 1 de enero 2024
    });
  ...
  describe('haversineDistance', () => {
    it('debería calcular distancias entre puntos geográficos', () => {
      ...
      const distance = haversineDistance(bogota.lat, bogota.lng, medellin.lat, medellin.lng);
    ...
    it('debería manejar coordenadas negativas', () => {
      const distance = haversineDistance(-33.4489, -70.6693, -34.6037, -58.3816);
