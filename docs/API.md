...
| POST   | `/internal/clients/find-or-create`      | Busca o crea la ficha de quien reserva; con sesión identifica por el token, no por el contacto del cuerpo; 409 si el contacto ya es de otra ficha |
