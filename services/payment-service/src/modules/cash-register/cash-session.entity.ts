...
export class CashSessionEntity extends TenantEntity {
  ...
  @Column({ type: "decimal", precision: 10, scale: 2, transformer: numericTransformer, name: "opening_amount" }) openingAmount!: number;
  @Column({ type: "decimal", precision: 10, scale: 2, transformer: numericTransformer, name: "closing_amount", nullable: true }) closingAmount!: number;
