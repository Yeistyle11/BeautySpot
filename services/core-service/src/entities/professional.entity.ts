...
export class Professional extends TenantEntity {
  ...
  @Column({ type: "jsonb", nullable: true }) portfolio!: { image: string; title?: string; description?: string }[];
  ...
  @ManyToOne(() => ProfessionalCategoryEntity, (cat) => cat.professionals, { nullable: true })
