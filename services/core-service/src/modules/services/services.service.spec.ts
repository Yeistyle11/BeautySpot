...
describe('ServicesService', () => {
  ...
  describe('findByBusiness', () => {
    ...
    it('debería ordenar por categoría y luego por nombre', async () => {
      const service2 = { ...mockService, id: 'service-2', name: 'Barba', category: 'Beard' } as any;
      const service3 = { ...mockService, id: 'service-3', name: 'Color', category: 'Haircut' } as any;
  ...
  describe('update', () => {
    it('debería actualizar el servicio correctamente', async () => {
      ...
      const result = await service.update('service-123', 'business-123', updateData);
