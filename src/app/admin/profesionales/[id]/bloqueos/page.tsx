      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-lg bg-white p-6 shadow-md">
          ...
          <p className="mb-6 text-gray-600">
            Gestiona los días u horarios específicos en los que el profesional
            no estará disponible (vacaciones, permisos, etc.).
          </p>
          ...
          <div className="mt-8 flex gap-4">
            <button
              onClick={() =>
                router.push(
                  `/admin/profesionales/${professionalId}/disponibilidad`
                )
              }
