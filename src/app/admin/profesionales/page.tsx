...
export default async function ProfessionalsManagementPage() {
  ...
  // Obtener todos los profesionales con estadísticas
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">
                Administra los profesionales y sus servicios
              </p>
            </div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* Alerta si hay usuarios profesionales sin perfil */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-yellow-700">
                  Los siguientes usuarios tienen rol de profesional pero no
                  tienen un perfil de profesional creado:
                </p>
          ...
          <div className="rounded-lg bg-white p-6 shadow">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {professionals.filter((b) => b.active).length}
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {professionals.length > 0
                    ? (
                        professionals.reduce((sum, b) => sum + b.rating, 0) /
                        professionals.length
                      ).toFixed(1)
                    : "0.0"}
                </p>
        ...
        {professionalsWithStats.length === 0 ? (
          <div className="rounded-lg bg-white p-12 text-center shadow">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Los usuarios con rol PROFESSIONAL aparecerán aquí automáticamente
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {professionalsWithStats.map((professional) => (
              <div
                key={professional.id}
              ...
              >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-500">
                          ({professional.yearsExp} años exp.)
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-indigo-600">
                        {professional.stats.monthlyAppointments}
                      </p>
                ...
                <div className="border-t border-gray-200 p-6">
                  <div className="mb-2 flex items-center justify-between">
                    <h4 className="text-sm font-semibold text-gray-700">
                      Servicios ({professional.services.length})
                    </h4>
                    <Link
                      href="/admin/profesionales/servicios"
                  ...
                  {professional.services.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {professional.services.slice(0, 3).map((bs) => (
                        <span
                          key={bs.id}
                      ...
                      {professional.services.length > 3 && (
                        <span className="rounded bg-gray-100 px-2 py-1 text-xs text-gray-600">
                          +{professional.services.length - 3} más
                        </span>
                      )}
                    </div>
                  ) : (
                ...
                <div className="space-y-3 border-t border-gray-200 px-6 pb-6 pt-4">
                  <div className="grid grid-cols-2 gap-2">
                    <Link
                      href={`/admin/profesionales/${professional.id}/disponibilidad`}
                    ...
                    <Link
                      href={`/admin/profesionales/${professional.id}/bloqueos`}
                  ...
                  <Link
                    href={`/admin/profesionales/${professional.id}/editar`}
